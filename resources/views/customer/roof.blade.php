    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="nav">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-5">
            <ul class="nav navbar-nav">
                <li class="active"><a href="javascript:;">账号设置</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="active"><a href="javascript:;">账号设置</a></li>
                        <li><a href="{{url('cus/pwd')}}">修改密码</a></li>
                        <li class="divider"></li>
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" active="{{$acc_list->acc_cat}}" name="wechat_cat" style="display: inline;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="inputPassword3" name="wechat_id" value="{{$acc_list->acc_id}}" placeholder="公众号原始ID（例：gh_ac97ce30c110）">
                        </div>
                        <span class="text-danger"></span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="inputPassword3" name="wechat_num" value="{{$acc_list->acc_wechat}}" placeholder="您的微信账号（例：huanghe6233）">
                        </div>
                        <span class="text-danger"></span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="inputPassword3" name="appid" value="{{$acc_list->acc_appid}}" placeholder="您的开发者AppID">
                        </div>
                        <span class="text-danger"></span>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="inputPassword3" name="appsecret" value="{{$acc_list->acc_secret}}" placeholder="您的应用密钥">
                        </div>
                        <span class="text-danger"></span>
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $('#sub').click(function(){
        ...
        $.post('{{url('cus/roof')}}',data,function(res){
            if(res.error > 0){
                ...
                var t1 = function(){location = res.msg};
                setTimeout(t1,2000);
            }
        },'json');
    });
